...
function waitForServer(url: string, attempts = 60, delay = 500) {
...
(async () => {
  ...
  try {
    ...
    try {
      ...
      await page.setViewport({ width: 375, height: 667, deviceScaleFactor: 2, isMobile: true, hasTouch: true } as any);
