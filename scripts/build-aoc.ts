...
<head>
  ...
  <meta name="twitter:title" content="Day ${parseInt(d.day,10)}/${y} - ${escapeHtml(d.title)} — AoC ${y}">
  <meta name="twitter:description" content="${escapeHtml(d.description || excerpt)}">
  ...
  <script type="application/ld+json">${JSON.stringify({
    ...
    "@type":"Article",
    "headline": `Day ${parseInt(d.day,10)}/${y} - ${d.title}`,
    "description": d.description || excerpt,
    "datePublished": y,
    "author": {"@type":"Person","name":"GitSith"},
    "mainEntityOfPage": {"@type":"WebPage", "@id": `${BASE_URL}/aoc/${y}/${d.day}/`},
